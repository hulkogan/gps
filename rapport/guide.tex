...
\title{Rapport sur les GNSS}
\author{A. \textsc{Klipfel}\\
  \texttt{arnaud.klipfel@ensta-bretagne.org}}
\author{T. \textsc{Dupond}\\
  \texttt{thomas.dupond@ensta-bretagne.org}}
\author{C. \textsc{Fauchereau}\\
  \texttt{clement.fauchereau@ensta-bretagne.org}}
\author{M. \textsc{Erdogan}\\
  \texttt{murat.erdogan@ensta-bretagne.org}}
\date{\today}
\doctype{Guide de rédaction}
\promo{Version 1.1}
